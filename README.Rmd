...
annualized_mean_ror = round(annualize(claim1_data[ROR].mean(),n=5,periodicity=YEARS) * 100,2)
```

According to my calculations, the annualized average return on a five year investment in the TSX
made on any trading day from June 29, 1979 to April 20, 2015 is `r py$annualized_mean_ror`%. Hey! That's pretty close!

But how likely would you have gotten an annual rate of return of `r py$annualized_mean_ror`% after five years,
if you just happened to throw in a lump some investment in the TSX on some trading day from June 29, 1979 to April 20, 2015?
