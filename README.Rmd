...
would get, assuming they invested on a random day. In fact, it's more than `r py$q_mean`% of investors would get. It's also interesting to note that the min of the above distribution is `r py$min_ror`% and `r py$q0`% of investors got negative returns. But the max of the distribution is a whopping `r py$max_ror`%!
